	...
	return (
		<div className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-lg bg-[#202020]">
			...
			<img
				...
				alt=""
				className={[
					"pointer-events-none z-10 h-full w-full object-cover md:h-48 md:w-48 md:rounded-full md:shadow-lg",
					isCameraMute ? "" : "hidden",
				].join(" ")}
			/>
			<img
				...
				alt=""
				className={[
					"pointer-events-none absolute left-0 top-0 hidden h-full w-full object-cover blur md:block",
					isCameraMute ? "" : "hidden md:hidden",
				].join(" ")}
			/>
