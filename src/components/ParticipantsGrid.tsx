		...
		<div className={["grid flex-1 gap-4 overflow-hidden py-4", gridClass].join(" ")}>
			...
			<div className="relative overflow-hidden rounded-md">
				...
				>
					<div
						className={[
							"flex h-20 w-20 cursor-pointer items-center justify-center rounded-full bg-[#2f2f2f] text-5xl ring-slate-600 transition duration-200 ease-in-out hover:ring md:h-28 md:w-28",
							videoMute ? "" : "hidden",
						].join(" ")}
